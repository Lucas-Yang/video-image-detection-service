...
from model import model_path, paddle_ocr_client
...
class ImageQualityIndexGenerator(object):
    ...
    def get_ocr_result_list(self):
        ...
        border_dict = {'height_border': 0.2, 'width_border': 0.05}
        box_info_list = __img_std.detect(self.image_data, pse_min_area=500, **border_dict)
        ocr_result_list = []
