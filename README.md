...
- 接口描述：该接口用来获取输入视频与参考视频的质量评估，是一种全参考的客观评价方法，PSNR分数越高表示压缩后失真越小。可以认为0～20视频质量非常差，20～30视频质量差，30～40视频质量可以接受，>40视频质量好，接近原始视频。（注：当输入的两个视频完全一致时，psnr为0，本接口会返回"inf"字样）
